...
import static com.msxf.downloader.Preconditions.checkNotNull;
import static com.msxf.downloader.Utils.HTTP;
...
public final class DownloadRequest implements Comparable<DownloadRequest> {
  ...
  public static final class Builder {
    ...
    public Builder url(String url) {
      return uri(Uri.parse(checkNotNull(url, "url == null")));
    }
